...
const AuthLayout = ({ children }) => {
  return (
    <div className="flex">
      ...
      {/* RIGHT: Design + Image (hidden on small screens) */}
      <div className="hidden md:block w-[40vw] h-screen bg-violet-50 bg-auth-bg-img bg-cover bg-no-repeat bg-center overflow-hidden relative">
        ...
        <div className="w-48 h-56 rounded-[40px] border-[20px] border-fuchsia-500 absolute top-[30%] right-10" />
        <div className="w-48 h-48 rounded-[40px] bg-violet-500 absolute -bottom-7 -left-5" />

        <div className="grid grid-cols-1 z-20 px-10 pt-10">
          <StatsInfoCard
